...
/**
 * @file
 * Shared helper functions for the example backend's DevTools scripts.
 *
...
// @codeCoverageIgnoreStart
if (!function_exists('TemplateDevTools\quit') && !class_exists('PHPUnit\\Framework\\TestCase')) {
